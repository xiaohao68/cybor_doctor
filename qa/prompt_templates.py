from qa.purpose_type import intent_map

classifier_template = (
    f"你扮演文本分类的工具助手，类别有{len(intent_map)}种，"
    f"分别为：文本生成,图片生成,视频生成,音频生成,图片描述,问候语,PPT生成,Word生成,网络搜索,基于知识库,其他。"
    f"下面给出一些例子用来辅助你判别："
...
def build_classifier_prompt(text: str) -> str:
    ...
    :return: prompt
    """
    return f"{classifier_template} {text}"
